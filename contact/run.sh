...
time python findContact.py --clustering ../DEM/post/dump104000.generation ../DEM/post/generation.104000.contact_dump 
time python findContact.py --clustering ../DEM/post/dump300000.generation ../DEM/post/generation.300000.contact_dump
...
#only print contact to FT contact list when connected to main body, as option anyway (both)
