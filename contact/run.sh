...
#time python findContact.py --clustering --writeOnlyConnected ../DEM/post/dump104000.generation ../DEM/post/generation.104000.contact_dump 
#time python findContact.py --clustering --writeOnlyConnected ../DEM/post/dump300000.generation ../DEM/post/generation.300000.contact_dump
